...
public class MemberDAOImpl extends MemberDAO{
	...
	public static MemberDAO getInstance() {
		cmaLogger.debug("LOGGING = MemberDAO.getInstance() ");
		return memberDAOImpl;
	}

	private static final String domainClassName = "com.imagsky.v6.domain.Member";
	...
	public Object create(Object obj) throws BaseDBException {
		cmaLogger.debug("MemberDAOImpl.create: [START]");
