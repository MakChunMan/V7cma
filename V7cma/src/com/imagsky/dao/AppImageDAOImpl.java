...
public class AppImageDAOImpl extends AppImageDAO {
    ...
    protected static final String thisDomainClassName = "com.imagsky.v8.domain.AppImage";
	...
	public Object CNT_update(Object obj) throws BaseDBException {
	        ...
	        try {
	            ...
	            cmaLogger.debug("DAO is_published:"+ image.isSys_is_published());
	            ...
	            cmaLogger.error("CNT_update Error: " + image.getImageUrl(), e);
	            return null;
	        }
	        return image;
	}
