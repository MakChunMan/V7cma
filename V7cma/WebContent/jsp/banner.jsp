...
<title><%=MessageUtil.getV6Message(lang,"TIT_BANNER") %> @ <%=MessageUtil.getV6Message(lang,"TIT_CORP") %></title>
	...
	<div id="content">
		<div id="ctnMain">
			<div id="mod_register" class="mod">
				<div class="hd2">
					<h2><%=MessageUtil.getV6Message(lang,"TIT_BANNER") %></h2>
				</div>
				<div class="bd" id="banner-region">
					<jsp:include page="/jsp/inc_banner.jsp"></jsp:include>		
				</div>
