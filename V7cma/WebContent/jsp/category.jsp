...
<title><%=MessageUtil.getV6Message(lang,"TIT_CAT") %> @ <%=MessageUtil.getV6Message(lang,"TIT_CORP") %></title>
...
<div id="main_container">
	...
	<div id="content">
		<div id="ctnMain">
			<div id="mod_cat" class="mod">
				<div class="hd2">
					<h2><%=MessageUtil.getV6Message(lang,"CAT_NAME")%></h2>
				</div>
				<div class="bd" id="cat-region">
					<% if(CommonUtil.null2Empty(
							request.getAttribute(SystemConstants.REQ_ATTR_INC_PAGE)).equalsIgnoreCase(
									CMAJspMapping.JSP_CATLIST_AJAX)){  %>
					<jsp:include page="/jsp/inc_catList.jsp"></jsp:include>
					<% } else { %>
					<jsp:include page="/jsp/inc_catAdd.jsp"></jsp:include>
					<% }  %>
				</div>
