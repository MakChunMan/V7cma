...
<title><%=MessageUtil.getV6Message(lang,"TIT_PROFILE") %> @ <%=MessageUtil.getV6Message(lang,"TIT_CORP") %></title>
	...
	<div id="content">
		<div id="ctnMain">
			<div id="mod_profile" class="mod">
				<div class="hd2">
					<h2><%=MessageUtil.getV6Message(lang,"TIT_PROF_MAIN")%></h2>
				</div>
				<div class="bd" id="profile-region">
					<jsp:include page="/jsp/inc_profile.jsp"></jsp:include>
				</div>
