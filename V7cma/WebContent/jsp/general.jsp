...
<title><%=MessageUtil.getV6Message(lang,"TIT_CORP") %></title>
	...
	<div id="content">
		<div id="ctnMain">
			<div id="mod_content_block" class="mod">
				<div class="hd2">
					<h2><%=CommonUtil.null2Empty(request.getAttribute(SystemConstants.REQ_ATTR_GENERAL_TITLE))%></h2>
				</div>
				<div class="bd" id="msg-region">
					<jsp:include page="/jsp/inc_general.jsp"></jsp:include>
				</div>
...
<% if(!CommonUtil.isNullOrEmpty((String)request.getAttribute("redirectURL"))){ %>
	<script>setTimeout('self.location="<%=request.getAttribute("redirectURL") %>";',1000);</script>
<% } %>
</body>
</html>
