...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><%=MessageUtil.getV6Message(lang, "TIT_ARTICLE")%> @ <%=MessageUtil.getV6Message(lang, "TIT_CORP")%></title>
    ...
    <body>
        <div id="main_container">
            ...
            <div id="content">
                <div id="ctnMainFull">
                    <div id="mod_content_block" class="mod">
                        <div class="hd2">
                            <h2><%=MessageUtil.getV6Message(lang, "TIT_ARTICLE")%></h2>
                        </div>
                        <div class="bd" id="arti-region">
                            <% if (CommonUtil.null2Empty(
                                        ...
                                        CMAJspMapping.JSP_ARTILIST_AJAX)) {%>
                            <jsp:include page="/jsp/inc_artiList.jsp"></jsp:include>
                            <% } else {%>
                            <jsp:include page="/jsp/inc_artiAdd.jsp"></jsp:include>
                            <% }%>
                        </div>
