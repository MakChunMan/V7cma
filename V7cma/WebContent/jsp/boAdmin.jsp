...
<script type="text/javascript" src="<%=staticPath %>/js/jquery-ui-timepicker-addon.js"/></script>
...
window.onload = function()
{
	...
	<script>self.location="/main.do";</script>
	<% } %>    
</head>
<body>
	...
	<div id="content">
		<div id="ctnMainFull">
			<div id="mod_content_block" class="mod">
				<div class="hd2">
					<h2><%=MessageUtil.getV6Message(lang,"TIT_BO_ADMIN") %></h2>
				</div>
				<div class="bd" id="boAdmin-region">
					<jsp:include page="/jsp/inc_boAdmin.jsp"></jsp:include>
				</div>
