                                ...
                                <tr>
                                    ...
                                    <td>
                                        <SELECT name="PACKAGE_TYPE" id="PACKAGE_TYPE">
                                                <OPTION value="1a">【免費】50 商品 （外部連結﹚</OPTION>
                                                <OPTION value="1b">【免費】20 商品 （站內上載﹚</OPTION>
                                                <OPTION value="2">【VIP商店】500 商品 （站內上載﹚- 月費HKD100 或年費HKD960</OPTION>
                                                <OPTION value="3">【獨立商店】1500商品 - 獨立商店手機應用程式 - 年費HKD960 及 Google及IOS上架費HKD3200</OPTION>
                                        </SELECT>
                                        <script>
