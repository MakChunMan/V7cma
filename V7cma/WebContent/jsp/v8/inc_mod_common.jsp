 ...
 %>
        <div class="form-group">
              ...
              <div class="col-md-9">
                  ...
                  <button type=button  class="btn btn-effect-ripple btn-warning" onclick="javascript:return uploadOnClick('mod_bg_response');">
        ...
        <div class="form-group">
              ...
              <div class="col-md-9">
                  ...
                  <button type=button  class="btn btn-effect-ripple btn-warning" onclick="javascript:return uploadOnClick('mod_icon_response');">
