...
<title><%=MessageUtil.getV6Message(lang,"TIT_LOGIN") %> @ <%=MessageUtil.getV6Message(lang,"TIT_CORP") %></title>
	...
	<div id="content">
		<div id="ctnMain">
			<div id="mod_login" class="mod">
				<div class="hd2">
					<h2><%=MessageUtil.getV6Message(lang,"TIT_LOGIN") %></h2>
				</div>
				<div class="bd" id="login-form-region">
					<jsp:include page="/jsp/inc_loginForm.jsp"></jsp:include>
				</div>
