...
<title><%=MessageUtil.getV6Message(lang,"TIT_BANKTRANSFER") %> @ <%=MessageUtil.getV6Message(lang,"TIT_CORP") %></title>
	...
	<div id="content">
		<div id="ctnMain">
			<div id="mod_checkout" class="mod">
				<div class="hd2">
					<h2><%=MessageUtil.getV6Message(lang,"TIT_BANKTRANSFER") %></h2>
				</div>
				<div class="bd" id="payment-region">
					<jsp:include page="/jsp/inc_banktransferupload.jsp"></jsp:include>
				</div>
