		...
		<div id="ctnMain">
			<div id="mod_txn" class="mod">
				...
				<div class="bd" id="txn-region">
					<form id="txn_history">
						<%=MessageUtil.getV6Message(lang, "TXN_DAYBACK_LABEL") %>
						<select name="dayback" id="dayback" />
							<option value="14"><%=MessageUtil.getV6Message(lang, "TXN_DAYBACK_14") %></option>
							<option value="30"><%=MessageUtil.getV6Message(lang, "TXN_DAYBACK_30") %></option>
						</select>&nbsp;
						<input type=button class="btn_generic" id="txn_hist_btn" value="<%=MessageUtil.getV6Message(lang,"BUT_SEARCH")%>"/>
					</form>
					<br/>
					<hr width="80%"/>
					<div id="txn_cash_txn">
					<jsp:include page="/jsp/inc_cashTransaction.jsp"/>
					</div>
				</div>
